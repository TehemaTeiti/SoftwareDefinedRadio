...
# Title: Top Block
# Generated: Fri Dec 21 18:15:12 2018
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._fl_range = Range(-500000, 400000, 10000, 50, 200)
        ...
        self.lf = filter.fir_filter_ccf(1, firdes.low_pass(
        	1, 1500000, 125000, 12500, firdes.WIN_HAMMING, 6.76))
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_gr_complex*1, 1500000,True)
        self.blocks_multiply_xx_0 = blocks.multiply_vcc(1)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, "/home/teiti/Etude/5ISS/SDR/fm_99500000_1500000.32fc", True)
        self.analog_sig_source_x_0 = analog.sig_source_c(1500000, analog.GR_COS_WAVE, fl, 1, 0)
        ...
        self.connect((self.blocks_multiply_xx_0, 0), (self.lf, 0))    
        self.connect((self.blocks_multiply_xx_0, 0), (self.qtgui_freq_sink_x_1, 0))    
        self.connect((self.blocks_throttle_0, 0), (self.qtgui_freq_sink_x_0, 0))    
        self.connect((self.lf, 0), (self.qtgui_freq_sink_x_2, 0))    
